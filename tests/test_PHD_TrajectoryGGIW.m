...
inner_filter = BREW.filters.TrajectoryGGIWEKF('dyn_obj', dyn, ...
    'H', H, 'process_noise', process_noise, 'measurement_noise', R, 'window_size', 20);
...
phd = BREW.multi_target.PHD('filter', inner_filter, 'birth_model', birth_model, ...
    'prob_detection', 0.98, 'prob_survive', 0.95, 'max_components', 50, ...
...
gifFile = fullfile('tests','output', 'TrajectoryGGIW_PHD_3D.gif');
