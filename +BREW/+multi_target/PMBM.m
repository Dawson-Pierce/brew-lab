classdef PMBM < handle
    %PMBM Poisson Multi-Bernoulli Mixture filter wrapper.
    ...
    methods
        function obj = PMBM(varargin)
            ...
            addParameter(p, 'prune_poisson_threshold', 1e-4);
            addParameter(p, 'merge_poisson_threshold', 4.0);
            addParameter(p, 'max_poisson_components', 100);
            addParameter(p, 'prune_threshold_hypothesis', 1e-3);
            addParameter(p, 'prune_threshold_bernoulli', 1e-3);
            addParameter(p, 'recycle_threshold', 0.1);
            ...
            params = struct( ...
                ...
                'prune_poisson_threshold', p.Results.prune_poisson_threshold, ...
                'merge_poisson_threshold', p.Results.merge_poisson_threshold, ...
                'max_poisson_components',  p.Results.max_poisson_components, ...
                ...
                'recycle_threshold', p.Results.recycle_threshold, ...
            ...
            obj.handle_ = brew_mex('create_rfs', 'PMBM', obj.dist_type_, ...
