classdef JGLMB < handle
    %JGLMB Joint Generalized Labeled Multi-Bernoulli filter wrapper.
    ...
    methods
        function obj = JGLMB(varargin)
            ...
            obj.handle_ = brew_mex('create_rfs', 'JGLMB', obj.dist_type_, ...
